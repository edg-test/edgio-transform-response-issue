...
class ModCache extends Mod_1.default {
    ...
    applyCacheReadFeatures(features) {
        ...
        const reqCacheControl = {
            ...
            ...(0, cache_control_parser_1.parse)(request.getHeader('pragma') || ''),
            // Overrides pragma when both are present
            ...(0, cache_control_parser_1.parse)(request.getHeader('cache-control') || ''),
        };
    ...
    applyResponseCachingHeaders() {
        ...
        const resCacheControl = {
            // Legacy header for HTTP/1.0
            ...(0, cache_control_parser_1.parse)(response.getHeader('pragma') || ''),
            // Overrides pragma when both are present
            ...(0, cache_control_parser_1.parse)(response.getHeader('cache-control') || ''),
        };
        ...
        if (response.statusCode !== 200 &&
            !cacheable_status_codes.includes(((_a = response.statusCode) !== null && _a !== void 0 ? _a : 0))) {
        ...
        const ttl = caching.max_age
            ...
            : (_c = (_b = resCacheControl['s-maxage']) !== null && _b !== void 0 ? _b : resCacheControl['max-age']) !== null && _c !== void 0 ? _c : getMaxAgeFromExpires();
        if (ttl === 0) {

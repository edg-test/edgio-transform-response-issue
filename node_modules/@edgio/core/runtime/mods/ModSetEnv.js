...
class ModSetEnv extends Mod_1.default {
    ...
    applyFeatures(features, _phase) {
        ...
        if (_phase === Phase_1.default.HandleResponseHeader ||
            ...
            ((_b = features.response) === null || _b === void 0 ? void 0 : _b.set_done) ||
            this.context.useCacheFile) {
            ((_c = features.headers) === null || _c === void 0 ? void 0 : _c.set_response_headers) &&
                this.context.setResponseHeader(features.headers.set_response_headers);
            ((_d = features.headers) === null || _d === void 0 ? void 0 : _d.add_response_headers) &&
                this.context.setResponseHeader((_e = features.headers) === null || _e === void 0 ? void 0 : _e.add_response_headers, true);
            (_g = (_f = features.headers) === null || _f === void 0 ? void 0 : _f.remove_response_headers) === null || _g === void 0 ? void 0 : _g.forEach(header => response.removeHeader(header));
            if ((_h = features.response) === null || _h === void 0 ? void 0 : _h.set_status_code)
                response.statusCode = features.response.set_status_code;
        }
        // only process response if processing response, or if exiting early through set_done
        if (_phase === Phase_1.default.SendRequestContent || ((_j = features.response) === null || _j === void 0 ? void 0 : _j.set_done)) {
            if ((_k = features.response) === null || _k === void 0 ? void 0 : _k.set_response_body) {
        ...
        if (((_l = features.response) === null || _l === void 0 ? void 0 : _l.set_done) && _phase !== Phase_1.default.HandleResponseHeader) {

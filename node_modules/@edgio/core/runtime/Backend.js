...
class Backend {
    ...
    getProxyRequestOptions(originUrl, req, options = {}) {
        ...
        const upstreamHeaders = {
            ...
            // In order for TLS verification to work, we cannot us the downstream host header, we
            // need to use the origin hostname instead, or if override_host_header is provided, we should use that.
            host: this.hostHeader /* origins.override_host_header from edgio.config.js */ ||
                originUrl.host /* origins.hosts.location from edgio.config.js */,
        };

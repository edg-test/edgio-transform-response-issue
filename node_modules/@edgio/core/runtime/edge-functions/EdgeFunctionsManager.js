...
class EdgeFunctionsManager {
    ...
    async runEdgeFunction(context, path, envVars, usrVars, rawBody) {
        ...
        const worker = new EdgeFunctionsWorkerManager_1.default(context, maybeRawBody, path, envVars, usrVars);

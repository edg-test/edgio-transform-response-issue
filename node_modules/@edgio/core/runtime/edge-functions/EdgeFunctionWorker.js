...
// src/runtime/edge-functions/Worker.ts
var getParentPort = () => {
  try {
...
// src/runtime/edge-functions/Serializer.ts
...
Serializer.getSerializerImplementation = () => {
  if (_Serializer.cachedSerializer)
    return _Serializer.cachedSerializer;
  try {
    _Serializer.cachedSerializer = require("v8");
  } catch (e) {
    _Serializer.cachedSerializer = {
      serialize: (data) => {
        return import_buffer.Buffer.from(new TextEncoder().encode(JSON.stringify(data)).buffer);
      },
      deserialize: (data) => {
        const dataCopy = import_buffer.Buffer.alloc(data.length);
        data.copy(dataCopy);
...
// src/runtime/edge-functions/EdgeFunctionParentInterface.ts
var import_buffer5 = require("buffer");

// src/runtime/edge-functions/EdgeFunctionMetrics.ts
var EdgeFunctionMetrics = class {
  constructor() {
    this.activeTimers = {};
...
// src/runtime/edge-functions/EdgeFunctionReason.ts
...
var HTTP_STATUS_REQUEST_ENTITY_TOO_LARGE = 413;
var HTTP_STATUS_REQUEST_URI_TOO_LONG = 414;
var HTTP_STATUS_UNSUPPORTED_MEDIA_TYPE = 415;
var HTTP_STATUS_REQUESTED_RANGE_NOT_SATISFIABLE = 416;
var HTTP_STATUS_EXPECTATION_FAILED = 417;
var HTTP_STATUS_IM_A_TEAPOT = 418;
...
var HTTP_STATUS_CUSTOM_INTERNAL_ERROR = 530;
var HTTP_STATUS_CUSTOM_UPSTREAM_TIMEOUT = 531;
var HTTP_STATUS_CUSTOM_RESPONSE_TOO_LARGE = 532;
var HTTP_STATUS_CUSTOM_TLS_ERROR = 533;
var HTTP_STATUS_CUSTOM_PROJECT_ERROR = 534;
var HTTP_STATUS_CUSTOM_UNKNOWN_PROJECT_ERROR = 535;
var HTTP_STATUS_CUSTOM_NO_RESPONSE_ERROR = 536;
var HTTP_STATUS_CUSTOM_DNS_RESOLUTION_ERROR = 537;
var HTTP_STATUS_CUSTOM_REQUEST_LOOP_ERROR = 538;
var HTTP_STATUS_CUSTOM_WORKER_TIMEOUT = 539;
var HTTP_STATUS_CUSTOM_OUT_OF_MEMORY_ERROR = 540;
var HTTP_STATUS_CUSTOM_OUT_OF_WORKERS_ERROR = 541;
var HTTP_STATUS_CUSTOM_HEADER_OVERFLOW_ERROR = 542;
var HTTP_STATUS_CUSTOM_GLOBAL_UPSTREAM_TIMEOUT = 543;
var HTTP_STATUS_CUSTOM_INVALID_HOST_HEADER = 544;
var HTTP_STATUS_CUSTOM_COMPONENT_NOT_READY = 545;
var HTTP_STATUS_CUSTOM_GLOBAL_TLS_ERROR = 546;
var HTTP_STATUS_CUSTOM_GLOBAL_NO_RESPONSE_ERROR = 547;
var HTTP_STATUS_CUSTOM_GLOBAL_DNS_RESOLUTION_ERROR = 548;
var HTTP_STATUS_CUSTOM_CAPTCHA_SERVED = 549;
var HTTP_STATUS_INTERNAL_SILENT_CLOSE = 888;
var HTTP_STATUS_INTERNAL_HOTFILE_REDIRECT = 893;
var EdgeFunctionReason_default = (statusCode) => {
  switch (statusCode) {
    ...
    case HTTP_STATUS_TOKEN_REQUIRED:
    ...
    case HTTP_STATUS_BAD_GATEWAY:
      return "Bad Gateway";
    case HTTP_STATUS_SERVICE_NOT_AVAILABLE:
    ...
    case HTTP_STATUS_CUSTOM_INTERNAL_ERROR:
      return "Internal Error";
    case HTTP_STATUS_CUSTOM_UPSTREAM_TIMEOUT:
      return "Project Upstream Connection Error";
    case HTTP_STATUS_CUSTOM_RESPONSE_TOO_LARGE:
      return "Project Response Too Large";
    case HTTP_STATUS_CUSTOM_TLS_ERROR:
      return "Project Upstream TLS Error";
    case HTTP_STATUS_CUSTOM_PROJECT_ERROR:
      return "Project Error";
    case HTTP_STATUS_CUSTOM_UNKNOWN_PROJECT_ERROR:
      return "Unknown Project";
    case HTTP_STATUS_CUSTOM_NO_RESPONSE_ERROR:
      return "Project HTTP Response Timeout";
    case HTTP_STATUS_CUSTOM_DNS_RESOLUTION_ERROR:
      return "Project DNS Resolution Error";
    case HTTP_STATUS_CUSTOM_REQUEST_LOOP_ERROR:
      return "Project Request Loop";
    case HTTP_STATUS_CUSTOM_WORKER_TIMEOUT:
      return "Project Timeout";
    case HTTP_STATUS_CUSTOM_OUT_OF_MEMORY_ERROR:
      return "Out Of Memory";
    case HTTP_STATUS_CUSTOM_OUT_OF_WORKERS_ERROR:
      return "Out Of Workers";
    case HTTP_STATUS_CUSTOM_HEADER_OVERFLOW_ERROR:
      return "Project Header Overflow";
    case HTTP_STATUS_CUSTOM_GLOBAL_UPSTREAM_TIMEOUT:
      return "Global Upstream Timeout";
    case HTTP_STATUS_CUSTOM_INVALID_HOST_HEADER:
      return "Invalid Host Header";
    case HTTP_STATUS_CUSTOM_COMPONENT_NOT_READY:
      return "Component Not Ready";
    case HTTP_STATUS_CUSTOM_GLOBAL_TLS_ERROR:
      return "Global POP TLS Error";
    case HTTP_STATUS_CUSTOM_GLOBAL_NO_RESPONSE_ERROR:
      return "Global POP No HTTP Response";
    case HTTP_STATUS_CUSTOM_GLOBAL_DNS_RESOLUTION_ERROR:
      return "Global POP DNS Resolution Error";
    case HTTP_STATUS_CUSTOM_CAPTCHA_SERVED:
      return "Captcha Served";
    case HTTP_STATUS_INTERNAL_SILENT_CLOSE:
      return "Internal Silent Close";
    case HTTP_STATUS_INTERNAL_HOTFILE_REDIRECT:
      return "Internal Hotfile Redirect";
    default:
      return "";
  }
};

// src/runtime/edge-functions/EdgeFunctionHeaders.ts
...
var WasmError = class {
  ...
  static ok() {
    return new WasmError(0 /* ok */, void 0);
  }
};
var WasmProgram = class {
...
var EdgeFunctionHeaders = class {
  constructor(headers) {
    if (Array.isArray(headers)) {
      ...
      this._headers = (headers == null ? void 0 : headers._headers) || headers || {};
    }
  }
  ...
  append(name, newValue) {
    ...
    if (Array.isArray(value)) {
      if (Array.isArray(validatedNewValue)) {
        value.concat(validatedNewValue);
      } else {
  ...
  headers() {
    return (0, import_lodash.pick)(this._headers, this.allowed_keys());
  }
  key(index) {
  ...
  static is_allowed_header_name(name, prohibitedHeaderNames) {
    return prohibitedHeaderNames.find((regex) => name.match(regex)) === void 0;
  }
  ...
  static is_allowed_write_header_name(name) {
    return EdgeFunctionHeaders.is_allowed_read_header_name(name) && EdgeFunctionHeaders.is_allowed_header_name(name, WRITE_PROHIBITED_HEADER_NAMES_REGEX);
  }
  ...
  static validate_header_name(name) {
    if (typeof name !== "string" || name.length === 0) {
      return new WasmError(5 /* invalid_argument */, "Header name is too short");
    }
    if (name.length > MAX_HEADER_NAME_LEN) {
      return new WasmError(5 /* invalid_argument */, `Header name is too long (length ${name.length} > ${MAX_HEADER_NAME_LEN})`);
    }
    if (!EdgeFunctionHeaders.weak_is_valid_header_name(name)) {
      return new WasmError(5 /* invalid_argument */, `Header name is invalid: ${name}`);
    }
    return WasmError.ok();
  }
  static validate_header_value(value) {
    ...
    if (value.length > MAX_HEADER_VALUE_LEN) {
      return new WasmError(5 /* invalid_argument */, `Header value is too long (length ${value.length} > ${MAX_HEADER_VALUE_LEN})`);
    }
    if (!EdgeFunctionHeaders.weak_is_valid_header_value(value)) {
      return new WasmError(5 /* invalid_argument */, `Header value is invalid: ${value}`);
    }
    return WasmError.ok();
  }
};

// src/runtime/edge-functions/EdgeFunctionRequest.ts
var EdgeFunctionRequest = class {
  constructor(method, url) {
    this.method = "GET";
    this.rawBody = void 0;
    this.protocol = "http";
    this.headers = new EdgeFunctionHeaders({});
    this.method = method;
    this.url = url;
    const urlObject = new URL(url);
    this.path = urlObject.pathname;
    this.protocol = urlObject.protocol.replace(":", "");
    this.headers = new EdgeFunctionHeaders({ host: urlObject.hostname });
  ...
  static createFromEdgeFunctionParams(params) {
    ...
    edgeRequest.headers = new EdgeFunctionHeaders(request.rawHeaders);
    return edgeRequest;
  }
  ...
  static createFromRequest(request) {
    ...
    clone_request.headers = new EdgeFunctionHeaders(request.getHeaders());
  ...
  static validate_uri(uri) {
    ...
    if (uri.length > MAX_HEADER_BYTES) {
      return new WasmError(8 /* limit_exceeded */, `URI length is too long (length ${uri.length} > ${MAX_HEADER_BYTES})`);
    }
    if (!uri.startsWith("http") && !uri.startsWith("/")) {
      return new WasmError(5 /* invalid_argument */, "Invalid request uri");
    }
    return WasmError.ok();
  }
};

// src/runtime/edge-functions/EdgeFunctionResponse.ts
var import_buffer2 = require("buffer");
var EdgeFunctionResponse = class {
  constructor({
    statusCode,
    statusMessage,
    body,
    ...
    if (import_buffer2.Buffer.isBuffer(body) || typeof body === "string" || body instanceof Uint8Array) {
      this.body = import_buffer2.Buffer.from(body);
    }
...
// src/runtime/edge-functions/EdgeFunctionError.ts
var EdgeFunctionError = /* @__PURE__ */ ((EdgeFunctionError2) => {
  EdgeFunctionError2[EdgeFunctionError2["Ok"] = 0] = "Ok";
  EdgeFunctionError2[EdgeFunctionError2["ErrorInitializing"] = 1] = "ErrorInitializing";
  EdgeFunctionError2[EdgeFunctionError2["ErrorRunning"] = 2] = "ErrorRunning";
  return EdgeFunctionError2;
})(EdgeFunctionError || {});
var EdgeFunctionError_default = EdgeFunctionError;

// src/runtime/edge-functions/EdgeFunctionsWasmManager.ts
var EdgeFunctionsWasmManager = class {
...
// src/utils/decodeBase64Validated.ts
var import_buffer3 = require("buffer");
var validBase64Regex = /^(?:[A-Za-z0-9+/]{4})*(?:[A-Za-z0-9+/]{2}==|[A-Za-z0-9+/]{3}=)?$/;
function decodeBase64ToBuffer(base64Input) {
  if (!validBase64Regex.test(base64Input)) {
    throw new Error(`Invalid base64 string`);
  }
  return import_buffer3.Buffer.from(base64Input, "base64");
}

// src/runtime/edge-functions/EdgeFunction.ts
...
var ENV_VAR_NAMESPACE_EDGIO_CONFIG = "edgio-config";
var ENV_VAR_NAMESPACE_EDGIO_ORIGINS = "edgio-origins";
var ENV_VAR_NAMESPACE_EDGIO_USRVAR = "edgio-usrvar";
...
var overflow_message = "<truncated>";
var MAX_OUT_BYTES = 2048;
var MAX_PANIC_BYTES = 512;
var EdgeFunction = class extends WasmProgram {
  constructor(parent, params) {
    super();
    this.response = new EdgeFunctionResponse({});
    this.metrics = new EdgeFunctionMetrics();
  ...
  static async getQuickJsCore() {
    if (!EdgeFunction.QuickJsModule) {
      const wasmBytes = await EdgeFunctionsWasmManager.getQuickjsRuntimeBytes();
  ...
  async run() {
    const module2 = await EdgeFunction.getQuickJsCore();
    ...
    if (status !== EdgeFunctionError_default.Ok) {
    ...
    if (this.params.request.method == "HEAD") {
      this.response.body = import_buffer4.Buffer.from("");
    }
  ...
  funDebug(...args) {
    for (let i = 0; i < args.length; i++) {
      const arg = args[i];
      if (import_buffer4.Buffer.isBuffer(arg)) {
        this.parent.writeToDebugStream(arg);
      } else if (typeof (arg == null ? void 0 : arg.toString) === "function") {
        this.parent.writeToDebugStream(import_buffer4.Buffer.from(arg.toString()));
      } else if (typeof arg === "undefined") {
        this.parent.writeToDebugStream(import_buffer4.Buffer.from("undefined"));
      } else {
        this.parent.writeToDebugStream(import_buffer4.Buffer.from(`[unhandled type ${typeof arg}]`));
      }
      if (i < args.length - 1) {
        this.parent.writeToDebugStream(import_buffer4.Buffer.from(" "));
      }
    }
    this.parent.writeToDebugStream(import_buffer4.Buffer.from("\n"));
  }
  stringLengthsToBuffer(values) {
    ...
    for (let i = 0; i < itemCount; i++) {
      view.setUint32(i * uint32Size, values[i].length, true);
    }
    return import_buffer4.Buffer.from(new Uint8Array(arr));
  }
  getQuickJsImportObject() {
    let requests = /* @__PURE__ */ new Map();
    requests.set(this.DOWNSTREAM_REQUEST_ID, EdgeFunctionRequest.createFromEdgeFunctionParams(this.params));
    ...
    const startTimeNs = BigInt(Date.now() * 1e3);
    ...
    const is_allowed_usrvar_name = (name) => {
      ...
      return lowerName.startsWith("geo_") || lowerName.startsWith("usrvar_") || lowerName.startsWith("virt_") || lowerName.startsWith("wurfl_");
    };
    return {
      env: {
        ...
        hostcall_dict_check: (ns_offset, ns_len, name_offset, name_len) => {
          ...
          if (ns === ENV_VAR_NAMESPACE_EDGIO_CONFIG) {
            const name = this.getStringFromGuestMemory(memory, name_offset, name_len);
            return this.params.envVars.has(name) ? 0 /* ok */ : 2 /* not_found */;
          }
        ...
        hostcall_unique_set_check: (ns_offset, ns_len, name_offset, name_len) => {
          ...
          const name = this.getStringFromGuestMemory(memory, name_offset, name_len);
          return this.params.origins.find((x) => x.name === name) !== void 0 ? 0 /* ok */ : 2 /* not_found */;
        },
        ...
        hostcall_req_create: (method_offset, method_len, url_offset, url_len, req_id_offset) => {
          ...
          const uri_validate_result = EdgeFunctionRequest.validate_uri(url);
          if (uri_validate_result.status !== 0 /* ok */) {
            return handleWasmError(uri_validate_result);
          }
          const request = EdgeFunctionRequest.createFromMethodAndUrl(method, url);
        ...
        hostcall_req_clone_without_body: (id, clone_id_offset) => {
          ...
          if (request instanceof WasmError) {
            return handleWasmError(request);
          }
          const clone_request = EdgeFunctionRequest.createFromRequest(request);
        ...
        hostcall_resp_create: (status, resp_id_offset) => {
          ...
          const response = new EdgeFunctionResponse({
            statusCode: status
          });
        ...
        hostcall_resp_clone_without_body: (id, clone_id_offset) => {
          ...
          if (response instanceof WasmError) {
            return handleWasmError(response);
          }
          const clone_response = EdgeFunctionResponse.createFromResponse(response);
        ...
        hostcall_req_fetch_async: (id) => {
          ...
          if (request.fetchOrigin === void 0) {
            return handleWasmError({
              status: 6 /* invalid_operation */,
              message: `Fetch failed: No fetch origin was set`
            });
          }
          if (!this.params.origins.find((x) => x.name === request.fetchOrigin) === void 0) {
            return handleWasmError({
              status: 6 /* invalid_operation */,
        ...
        hostcall_resp_await_next: (pending_request_offset, response_or_response_error_code_offset, result_type_offset) => {
          ...
          if (response.response) {
            ...
            memory.setUint32(result_type_offset, 1);
            responses.set(responseId, new EdgeFunctionResponse(response.response));
          } else {
            ...
            memory.setUint32(result_type_offset, 0);
          }
          return 0 /* ok */;
        },
        ...
        hostcall_req_set_uri: (id, data_offset, len) => {
          ...
          const uri_validate_result = EdgeFunctionRequest.validate_uri(uri);
          if (uri_validate_result.status !== 0 /* ok */) {
            return handleWasmError(uri_validate_result);
          }
          request.url = uri;
        ...
        hostcall_req_set_body: (id, data_offset, len) => {
          ...
          request.rawBody = import_buffer4.Buffer.from(body);
        ...
        hostcall_req_get_body: (id, data_offset, len_offset) => {
          ...
          return this.copyDataToGuestMemory(request.rawBody || import_buffer4.Buffer.alloc(0), data_offset, len_offset);
        },
        ...
        hostcall_resp_get_reason: (id, data_offset, len_offset) => {
          ...
          const reason = EdgeFunctionReason_default(response.statusCode);
        ...
        hostcall_resp_set_body: (id, ptr, len) => {
          ...
          response.body = import_buffer4.Buffer.from(body);
        ...
        hostcall_panic_hook: (msg_offset, msg_length) => {
          ...
          const msgAsBuf = import_buffer4.Buffer.from(msg);
          if (msg_length + overflow_message.length >= MAX_PANIC_BYTES) {
            this.parent.writeToStderr(msgAsBuf.slice(0, MAX_PANIC_BYTES));
            this.parent.writeToStderr(import_buffer4.Buffer.from(overflow_message));
        ...
        hostcall_req_get_header_name_by_idx: (id, idx_offset, key_offset, key_length) => {
          ...
          if (!headerName || !EdgeFunctionHeaders.is_allowed_read_header_name(headerName)) {
            return 2 /* not_found */;
          }
          this.funDebug("hostcall_req_get_header_name_by_idx()", idx, headerName);
          return this.copyDataToGuestMemory(import_buffer4.Buffer.from(headerName), key_offset, key_length);
        },
        hostcall_req_get_header_values: (id, key_offset, key_length, sizes_offset, sizes_length_offset, values_offset, values_length_offset) => {
          const request = getRequest(id);
          if (request instanceof WasmError) {
            return handleWasmError(request);
          }
          ...
          if (!EdgeFunctionHeaders.is_allowed_read_header_name(key)) {
            return 2 /* not_found */;
          }
          ...
          if (rc !== 0 /* ok */)
            return rc;
          return this.copyDataToGuestMemory(import_buffer4.Buffer.from(headerValues.join("")), values_offset, values_length_offset);
        },
        hostcall_req_set_header: (id, key_offset, key_length, val_offset, val_length) => {
          ...
          const memory = this.getGuestMemory();
          const key = this.getStringFromGuestMemory(memory, key_offset, key_length);
          const key_validate_result = EdgeFunctionHeaders.validate_header_name(key);
          if (key_validate_result.status !== 0 /* ok */) {
            return handleWasmError(key_validate_result);
          }
          if (!EdgeFunctionHeaders.is_allowed_write_header_name(key)) {
            return handleWasmError({
              status: 5 /* invalid_argument */,
          ...
          const val_validate_result = EdgeFunctionHeaders.validate_header_value(val);
          if (val_validate_result.status !== 0 /* ok */) {
        ...
        hostcall_req_remove_header: (id, key_offset, key_length) => {
          ...
          return request.removeHeader(key) ? 0 /* ok */ : 2 /* not_found */;
        },
        hostcall_req_check_header: (id, key_offset, key_length) => {
          ...
          const exists = request.getHeader(key) !== void 0;
          this.funDebug(`hostcall_req_check_header() ${id}, '${key}' returns: ${exists}`);
          return exists ? 0 /* ok */ : 2 /* not_found */;
        },
        ...
        hostcall_resp_get_header_values: (id, key_offset, key_length, sizes_offset, sizes_length_offset, values_offset, values_length_offset) => {
          const response = getResponse(id);
          if (response instanceof WasmError) {
            return handleWasmError(response);
          }
        ...
        hostcall_resp_remove_header: (id, key_offset, key_length) => {
          ...
          return response.headers.remove(key) ? 0 /* ok */ : 2 /* not_found */;
        },
        hostcall_resp_check_header: (id, key_offset, key_length) => {
          ...
          return response.headers.check(key) ? 0 /* ok */ : 2 /* not_found */;
        },
        hostcall_resp_get_body: (id, data_offset, len_offset) => {
          ...
          return this.copyDataToGuestMemory(response.body || import_buffer4.Buffer.alloc(0), data_offset, len_offset);
        },
      ...
      wasi_snapshot_preview1: {
        fd_write: (fd, iovs_offset, iovs_length, bw_offset) => {
          ...
          for (let i = 0; i < iovs_length; i++) {
            ...
            const iov_len = memory.getUint32(iovs_offset + SIZEOF_wasi_iovec_t * i + Uint32Array.BYTES_PER_ELEMENT);
            const iovs = import_buffer4.Buffer.from(memory.slice(iov_base, iov_base + iov_len));
            switch (fd) {
              case STDOUT_FD: {
                ...
                if (bytes_remaining > 0) {
                  if (iov_len + overflow_message.length >= bytes_remaining) {
                    ...
                    this.parent.writeToStdout(import_buffer4.Buffer.from(overflow_message));
                ...
                if (typeof window === void 0 && ((_a = process == null ? void 0 : process.env) == null ? void 0 : _a.LOG_LEVEL) === "trace") {
              ...
              case STDERR_FD: {
                ...
                if (typeof window === void 0 && ((_b = process == null ? void 0 : process.env) == null ? void 0 : _b.LOG_LEVEL) === "trace") {
...
// src/runtime/edge-functions/EdgeFunctionParentInterface.ts
var EdgeFunctionParentInterface = class {
  constructor() {
    this.started = false;
    this.port = parentPort;
    this.workerData = void 0;
  }
  startListening() {
    if (this.started) {
      return;
    ...
    this.port.onmessage = async (event) => {
      ...
      if (command === "run") {
        ...
        try {
          const fun = new EdgeFunction(this, this.workerData.params);
          const response = await fun.run();
  ...
  waitNextReadyResponseSync() {
    ...
    this.writeToDebugStream(import_buffer5.Buffer.from("Block until the next response is ready..."));
    Atomics.store(semaphore, 0, 0);
    Atomics.wait(semaphore, 0, 0);
    this.writeToDebugStream(import_buffer5.Buffer.from("A new response is ready..."));
    const length = dataLength[0];
    const deserializedData = Serializer.deserialize(import_buffer5.Buffer.from(exchangeBuffer, 0, length));
    if ((_a = deserializedData.response) == null ? void 0 : _a.body) {
      deserializedData.response.body = import_buffer5.Buffer.from((_b = deserializedData.response) == null ? void 0 : _b.body);
    }
    return deserializedData;
  }
  get path() {
    var _a;
    return ((_a = this.workerData) == null ? void 0 : _a.params.path) ?? "Unknown";
  }
};

// src/runtime/edge-functions/EdgeFunctionWorker.ts
try {
  const parentInterface = new EdgeFunctionParentInterface();
  parentInterface.startListening();
} catch (e) {
 ...
 */
//# sourceMappingURL=EdgeFunctionWorker.js.map

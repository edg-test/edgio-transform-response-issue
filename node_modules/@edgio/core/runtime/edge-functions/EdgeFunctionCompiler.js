...
class EdgeFunctionCompilation extends WasmProgram_1.default {
    ...
    async run() {
        ...
        const importObject = this.getQuickJsImportObject(this.source);
...
async function compileEdgeFunction(source) {
    const compilation = new EdgeFunctionCompilation(source);

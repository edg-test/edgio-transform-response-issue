...
exports.set = exports.get = exports.withContext = void 0;
...
function createClsNamespace() {
    const cls = (0, nonWebpackRequire_1.default)('cls-hooked');
    if (!clsNamespace) {
...
function getClsNamespace() {
    return (0, nonWebpackRequire_1.default)('cls-hooked').getNamespace(CONTEXT);
}
/**

...
export interface CustomConnectorConfig {
    /**
     *  Build folder location for the underlaying framework.
     */
    buildFolder?: string;
    /**
     * Entry file location for the underlaying framework.
     */
    entryFile?: string;
    /**
     * Environment variable name used to set the port for the underlaying framework.
     */
    envPort?: string;
    /**
     * Build command to run when building the underlaying framework.
     */
    buildCommand?: string;
    /**
     * Dev command to run when running the underlaying framework in dev mode.
     */
    devCommand?: string;
    /**
     * Build ready message to look for when building the underlaying framework with dev command.
     * Until this message is outputed by the underlaying framework, the build is not considered ready.
...
export default interface Config extends Property {
    ...
    /**
     * If '@edgio/custom-connector' is used as the connector, this value will be used to configure it.
     */
    customConnector?: CustomConnectorConfig;
}
/**

 ...
 * @private
 */
export declare const EDGIO_SERVERLESS_HINT_HEADER = "x-edg-serverless-hint";
/**
 * Instructs the runtime to forward the request directly one of the router's functions by hint name.
 * @private
 */
export declare const EDGIO_SERVERLESS_HINTS: {
    readonly app: "app";
    readonly compute: "compute";
    readonly redirect: "redirect";
    readonly proxy: "proxy";
};
export type EdgioServerlessHint = (typeof EDGIO_SERVERLESS_HINTS)[keyof typeof EDGIO_SERVERLESS_HINTS];
/**

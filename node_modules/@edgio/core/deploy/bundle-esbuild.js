...
async function bundleRouterAndConfig(options = {}) {
    ...
    const destRouterPath = (0, path_1.join)(process.cwd(), paths_1.JS_DIR, paths_1.ROUTES_FILE_NAME);
    const destConfigPath = (0, path_1.join)(process.cwd(), paths_1.JS_DIR, paths_1.CONFIG_FILE_NAME);
    await Promise.all([
        bundle({
            ...options,
        ...
        bundle({
            ...options,
            entryPoints: [(0, paths_1.getConfigSrcPath)()],

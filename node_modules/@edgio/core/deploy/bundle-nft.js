...
async function bundleWithNft(src, destDir) {
    ...
    for (let file of fileList) {
        const dest = (0, path_1.join)(destDir, file);
        (0, fs_extra_1.mkdirpSync)((0, path_1.dirname)(dest));
        (0, fs_extra_1.copyFileSync)(file, dest);
    }
    const entryPoint = (0, path_1.join)(destDir, 'index.js');
    if (!(0, fs_extra_1.existsSync)(entryPoint)) {
        (0, fs_extra_1.writeFileSync)(entryPoint, `require('./${(0, slash_1.default)((0, path_1.relative)(process.cwd(), src))}')`, 'utf8');
    }

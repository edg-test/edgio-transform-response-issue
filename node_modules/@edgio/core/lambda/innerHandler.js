...
const requestHandler = new RequestHandler_1.default(process.cwd(), (0, origins_1.getEdgioOrigins)());
/**
...
async function innerHandler(event, instance) {
    ...
    switch (event.action) {
        case 'getEdgeConfig':
            return new RequestHandler_1.default(process.cwd(), (0, origins_1.getEdgioOrigins)(true)).createEdgeConfig();
...
async function startApp(port) {
    const modulePath = (0, path_1.join)(process.cwd(), (0, paths_1.pathForBackend)(constants_1.BACKENDS.js));
    if ((0, fs_extra_1.existsSync)(modulePath)) {
        let prod = (0, nonWebpackRequire_1.default)(modulePath);
        if (prod.default) {
            prod = prod.default;
        }

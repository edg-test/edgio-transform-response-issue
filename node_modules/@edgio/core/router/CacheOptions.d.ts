...
export interface CacheOptions {
     ...
     * `x-edg-upstream-requests` header.
     */
...
export interface BrowserCacheOptions {
     ...
     *
     * When `true`, the service worker will add the request body as the `pref_edgio_body` parameter.
     ...
     *
     * @private - Until we ensure that the edgio_head requests are viable
     */
    spa?: boolean;
}

...
const getLambdaResponse = (response) => {
    ...
    lambdaResponse.setOnHeaders(() => response.writeHead(lambdaResponse.statusCode, lambdaResponse.statusMessage, lambdaResponse.getHeaders()));
    return lambdaResponse;
};
async function createDevServer(options) {
    var _a, _b;
    process.env[constants_1.EDGIO_ENV_VARIABLES.local] = 'true';
    const handler = new RequestHandler_1.default(paths_1.JS_DIR, (0, origins_1.getEdgioOrigins)());
    ...
    const onRebuild = async () => {
        ...
        await (0, edge_functions_1.watchEdgeFunctions)(router.rules, routerSrcPath);
